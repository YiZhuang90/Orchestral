...
This document has been generalized into [CROSS_SESSION_WORKFLOW.md](./CROSS_SESSION_WORKFLOW.md), which covers all session types (planning, coding, landing, debug), not just coding. Kept for historical reference.
...
- below [THREAD_CONTEXT_MANAGEMENT_CONTRACT.md](./THREAD_CONTEXT_MANAGEMENT_CONTRACT.md),
- beside [CROSS_THREAD_DEV_WAITLIST.md](./CROSS_THREAD_DEV_WAITLIST.md),
- and above [MODULE_DEVELOPMENT_WORKFLOW.md](./MODULE_DEVELOPMENT_WORKFLOW.md).

...
This document sits **above** the single-slice workflow in [MODULE_DEVELOPMENT_WORKFLOW.md](C:/Users/Yi%20Zhuang/OneDrive/Codes/Projects/Orchestral/docs/development/MODULE_DEVELOPMENT_WORKFLOW.md).
...
- `docs/development/handoffs/YYYY-MM-DD-<item-name>-handoff.md`
